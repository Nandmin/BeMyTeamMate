...
export const TRANSLATIONS = {
  ...
  'profile.sidebar.balance': { hu: 'Egyenleg', en: 'Balance' },
  ...
  'groupSettings.tabs.payments': { hu: 'Befizetések', en: 'Payments' },

  'createEvent.payment.sectionTitle': { hu: 'Tagdíj / esemény díj', en: 'Membership fee / event fee' },
  'createEvent.payment.typeLabel': { hu: 'Díjtípus', en: 'Fee type' },
  'createEvent.payment.type.perPerson': { hu: '/ fő díj', en: 'Per person' },
  'createEvent.payment.type.total': { hu: 'Összes díj', en: 'Total fee' },
  'createEvent.payment.amountLabel': { hu: 'Összeg', en: 'Amount' },
  'createEvent.payment.dueDateLabel': { hu: 'Fizetési határidő', en: 'Payment due date' },
  'createEvent.payment.help': {
    hu: 'Összes díjnál a rendszer a résztvevők aktuális száma alapján automatikusan számolja a /fő összeget. Csak az „ott leszek” státuszú tagoknál keletkezik tartozás.',
    en: 'For total fees, the system automatically calculates the per-person amount based on the current number of attendees. Only members with an "I\'ll attend" response will have a balance.',
  },
  'createEvent.payment.disabled': {
    hu: 'Az eseményhez nem tartozik befizetési kötelezettség.',
    en: 'This event has no payment obligation.',
  },

  'payments.section.title': { hu: 'Befizetések', en: 'Payments' },
  'payments.section.description': {
    hu: 'Eseménydíjak, tagonkénti tartozások, befizetések és audit napló.',
    en: 'Event fees, member balances, payments, and audit log.',
  },
  'payments.methods.cash': { hu: 'Készpénz', en: 'Cash' },
  'payments.methods.bankTransfer': { hu: 'Banki átutalás', en: 'Bank transfer' },
  'payments.methods.revolut': { hu: 'Revolut', en: 'Revolut' },
  'payments.methods.other': { hu: 'Egyéb', en: 'Other' },
  'payments.status.paid': { hu: 'Rendezve', en: 'Settled' },
  'payments.status.partial': { hu: 'Részben rendezve', en: 'Partially paid' },
  'payments.status.unpaid': { hu: 'Hátralék', en: 'Outstanding' },
  'payments.bookkeeping.title': { hu: 'Könyvelés', en: 'Bookkeeping' },
  'payments.bookkeeping.selectUser': { hu: 'Válassz tagot', en: 'Select member' },
  'payments.bookkeeping.selectEvent': { hu: 'Válassz eseményt', en: 'Select event' },
  'payments.bookkeeping.empty.chooseUserOrEvent': {
    hu: 'A könyveléshez válassz tagot vagy eseményt.',
    en: 'Choose a member or an event to start bookkeeping.',
  },
  'payments.bookkeeping.empty.noOpenObligationForUser': {
    hu: 'A kiválasztott tagnak jelenleg nincs nyitott fizetési kötelezettsége.',
    en: 'The selected member currently has no open payment obligation.',
  },
  'payments.bookkeeping.empty.chooseEventForUser': {
    hu: 'Válassz eseményt a kiválasztott taghoz.',
    en: 'Select an event for the selected member.',
  },
  'payments.bookkeeping.empty.chooseUserForEvent': {
    hu: 'Válassz tagot a kiválasztott eseményhez.',
    en: 'Select a member for the selected event.',
  },
  'payments.bookkeeping.empty.noRespondedAttendees': {
    hu: 'Ennél az eseménynél még nincs visszajelzett résztvevő.',
    en: 'There are no confirmed attendees for this event yet.',
  },
  'payments.bookkeeping.empty.chooseUser': {
    hu: 'Válassz tagot a könyveléshez.',
    en: 'Select a member for bookkeeping.',
  },
  'payments.bookkeeping.labels.status': { hu: 'Státusz:', en: 'Status:' },
  'payments.bookkeeping.labels.paidSoFar': { hu: 'Eddig fizetett:', en: 'Paid so far:' },
  'payments.bookkeeping.labels.amountDue': { hu: 'Fizetendő:', en: 'Amount due:' },
  'payments.bookkeeping.labels.balance': { hu: 'Egyenleg:', en: 'Balance:' },
  'payments.bookkeeping.labels.date': { hu: 'Dátum:', en: 'Date:' },
  'payments.bookkeeping.labels.amount': { hu: 'Összeg:', en: 'Amount:' },
  'payments.bookkeeping.labels.method': { hu: 'Fizetési mód:', en: 'Payment method:' },
  'payments.bookkeeping.labels.note': { hu: 'Megjegyzés:', en: 'Note:' },
  'payments.bookkeeping.labels.notePlaceholder': { hu: 'Opcionális', en: 'Optional' },
  'payments.bookkeeping.submit': { hu: 'Rögzítés', en: 'Record' },
  'payments.summary.title': { hu: 'Egyenleg', en: 'Balance' },
  'payments.summary.headers.user': { hu: 'Tag', en: 'Member' },
  'payments.summary.headers.amountDue': { hu: 'Fizetendő', en: 'Amount due' },
  'payments.summary.headers.amountPaid': { hu: 'Fizetett', en: 'Paid' },
  'payments.summary.headers.balance': { hu: 'Egyenleg', en: 'Balance' },
  'payments.summary.headers.status': { hu: 'Státusz', en: 'Status' },
  'payments.summary.empty': {
    hu: 'Nincs fizetési kötelezettség a kiválasztott szűrőkkel.',
    en: 'There is no payment obligation for the selected filters.',
  },
  'payments.filters.title': { hu: 'Szűrés', en: 'Filters' },
  'payments.filters.period.label': { hu: 'Időszak', en: 'Period' },
  'payments.filters.period.all': { hu: 'Teljes időszak', en: 'Entire period' },
  'payments.filters.period.week': { hu: 'Elmúlt hét', en: 'Past week' },
  'payments.filters.period.month': { hu: 'Elmúlt hónap', en: 'Past month' },
  'payments.filters.period.year': { hu: 'Elmúlt év', en: 'Past year' },
  'payments.filters.event': { hu: 'Esemény', en: 'Event' },
  'payments.filters.user': { hu: 'Tag', en: 'Member' },
  'payments.filters.allEvents': { hu: 'Összes esemény', en: 'All events' },
  'payments.filters.allUsers': { hu: 'Összes tag', en: 'All members' },
  'payments.filters.query': { hu: 'Lekérdezés', en: 'Query' },
  'payments.ledger.headers.event': { hu: 'Esemény', en: 'Event' },
  'payments.ledger.headers.date': { hu: 'Dátum', en: 'Date' },
  'payments.ledger.headers.dueDate': { hu: 'Határidő', en: 'Due date' },
  'payments.ledger.headers.name': { hu: 'Név', en: 'Name' },
  'payments.ledger.headers.amountDue': { hu: 'Fizetendő', en: 'Amount due' },
  'payments.ledger.headers.amountPaid': { hu: 'Befizetve', en: 'Paid' },
  'payments.ledger.headers.balance': { hu: 'Egyenleg', en: 'Balance' },
  'payments.ledger.headers.status': { hu: 'Státusz', en: 'Status' },
  'payments.ledger.empty': { hu: 'Nincs megjeleníthető sor.', en: 'There are no rows to display.' },
  'payments.audit.title': { hu: 'Módosítási napló', en: 'Audit log' },
  'payments.audit.entryCreate': {
    hu: '{{actorName}} rögzített {{amount}} befizetést: {{targetUserName}} / {{method}}.',
    en: '{{actorName}} recorded a {{amount}} payment: {{targetUserName}} / {{method}}.',
  },
  'payments.audit.empty': { hu: 'Még nincs könyvelési napló.', en: 'There is no bookkeeping log yet.' },
  'payments.record.errors.positiveAmount': {
    hu: 'A befizetés összege legyen pozitív szám.',
    en: 'The payment amount must be a positive number.',
  },
  'payments.record.errors.amountAndDateRequired': {
    hu: 'A rögzítéshez összeg és dátum is szükséges.',
    en: 'Both amount and date are required to record a payment.',
  },
  'payments.record.errors.amountAndDateTogether': {
    hu: 'Az összeg és a dátum csak együtt adható meg.',
    en: 'Amount and date must be provided together.',
  },
  'payments.record.errors.invalidDate': { hu: 'Érvénytelen fizetési dátum.', en: 'Invalid payment date.' },
  'payments.record.errors.dateRange': {
    hu: 'A befizetés dátuma nem lehet kisebb, mint az esemény dátuma, és nem lehet nagyobb a mai napnál.',
    en: 'The payment date cannot be earlier than the event date or later than today.',
  },
  'payments.record.errors.saveFailed': {
    hu: 'Nem sikerült rögzíteni a befizetést.',
    en: 'Failed to record the payment.',
  },
  'payments.record.success.saved': { hu: 'Befizetés rögzítve.', en: 'Payment recorded.' },
  'payments.export.sheet': { hu: 'Befizetések', en: 'Payments' },
  'payments.export.csvFile': { hu: 'befizetesek.csv', en: 'payments.csv' },
  'payments.export.xlsxFile': { hu: 'befizetesek.xlsx', en: 'payments.xlsx' },

  'myBalance.title': { hu: 'Saját egyenlegem', en: 'My balance' },
  'myBalance.description': {
    hu: 'Saját tartozásaid és korábbi befizetéseid csoportonként.',
    en: 'Your balances and past payments by group.',
  },
  'myBalance.currentBalance': { hu: 'Aktuális egyenleg', en: 'Current balance' },
  'myBalance.status.noDebt': { hu: 'Nincs tartozásod', en: 'You have no outstanding balance' },
  'myBalance.status.partial': { hu: 'Részben rendezve', en: 'Partially paid' },
  'myBalance.status.outstanding': { hu: 'Fizetésre vár', en: 'Payment pending' },
  'myBalance.kpis.amountDue': { hu: 'Fizetendő', en: 'Amount due' },
  'myBalance.kpis.amountPaid': { hu: 'Befizetve', en: 'Paid' },
  'myBalance.kpis.creditOrDebt': { hu: 'Egyenleg', en: 'Balance' },
  'myBalance.ledger.group': { hu: 'Csoport', en: 'Group' },
  'myBalance.ledger.event': { hu: 'Esemény', en: 'Event' },
  'myBalance.ledger.dueDate': { hu: 'Határidő', en: 'Due date' },
  'myBalance.ledger.amountDue': { hu: 'Fizetendő', en: 'Amount due' },
  'myBalance.ledger.status': { hu: 'Státusz', en: 'Status' },
  'myBalance.ledger.empty': {
    hu: 'Nincs nyitott befizetési kötelezettséged.',
    en: 'You have no open payment obligations.',
  },
  'myBalance.payments.title': { hu: 'Korábbi befizetések', en: 'Previous payments' },
  'myBalance.payments.date': { hu: 'Dátum', en: 'Date' },
  'myBalance.payments.group': { hu: 'Csoport', en: 'Group' },
  'myBalance.payments.event': { hu: 'Esemény', en: 'Event' },
  'myBalance.payments.amount': { hu: 'Összeg', en: 'Amount' },
  'myBalance.payments.method': { hu: 'Befizetés módja', en: 'Payment method' },
  'myBalance.payments.empty': {
    hu: 'Még nincs rögzített befizetésed.',
    en: 'You do not have any recorded payments yet.',
  },
