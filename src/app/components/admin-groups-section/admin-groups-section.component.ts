...
export class AdminGroupsSectionComponent {
  ...
  get pagedGroups(): AdminGroupsSectionComponent['groups'] {
  ...
  private saveCachedGroups(groups: AdminGroupsSectionComponent['groups']): void {
    try {
      if (typeof window === 'undefined' || !window.localStorage) return;
  ...
  private async fetchGroupRows(
    forceRefresh: boolean
  ): Promise<AdminGroupsSectionComponent['groups']> {
